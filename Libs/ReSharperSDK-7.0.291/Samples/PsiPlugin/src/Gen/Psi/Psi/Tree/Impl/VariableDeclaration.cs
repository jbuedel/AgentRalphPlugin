...
namespace JetBrains.ReSharper.PsiPlugin.Tree.Impl {
  internal partial class VariableDeclaration : PsiCompositeElement, JetBrains.ReSharper.PsiPlugin.Tree.IVariableDeclaration {
    internal VariableDeclaration() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.PsiPlugin.Tree.Impl.ElementType.VARIABLE_DECLARATION; }
    }
