...
namespace JetBrains.ReSharper.PsiPlugin.Tree.Impl {
  internal partial class ListExpression : PsiCompositeElement, JetBrains.ReSharper.PsiPlugin.Tree.IListExpression {
    internal ListExpression() : base() {
    }
    public override JetBrains.ReSharper.Psi.ExtensionsAPI.Tree.NodeType NodeType {
      get { return JetBrains.ReSharper.PsiPlugin.Tree.Impl.ElementType.LIST_EXPRESSION; }
    }
    ...
    public override void Accept<TContext>(JetBrains.ReSharper.PsiPlugin.Tree.TreeNodeVisitor<TContext> visitor, TContext context) {
      visitor.VisitListExpression(this, context);
    }
