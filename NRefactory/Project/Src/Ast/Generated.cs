...
namespace ICSharpCode.NRefactory.Ast {
	...
	public partial class  AddHandlerStatement : Statement {
		...
		public override IEnumerable<INode> Chilluns {
			get {
					yield return eventExpression;
					yield return handlerExpression;
			}
		}
	...
	public partial class  ArrayCreateExpression : Expression {
		...
		public override IEnumerable<INode> Chilluns {
			get {
					yield return createType;
					yield return arrayInitializer;
			}
		}
	...
	public partial class  ConstructorDeclaration : ParametrizedNode {
		...
		public override IEnumerable<INode> Chilluns {
			get {
					yield return constructorInitializer;
					yield return body;
			}
		}
	...
	public partial class  EventDeclaration : MemberNode {
		...
		public override IEnumerable<INode> Chilluns {
			get {
					yield return addRegion;
					yield return removeRegion;
					yield return raiseRegion;
	...
	public partial class  FixedStatement : StatementWithEmbeddedStatement {
		...
		public override IEnumerable<INode> Chilluns {
			get {
					yield return pointerDeclaration;
			}
		}
	...
	public partial class  ForNextStatement : StatementWithEmbeddedStatement {
		...
		public override IEnumerable<INode> Chilluns {
			get {
					...
					yield return step;
					yield return typeReference;
					yield return loopVariableExpression;
			}
		}
	...
	public partial class  IndexerDeclaration : AttributedNode {
		...
		public override IEnumerable<INode> Chilluns {
			get {
					yield return typeReference;
					yield return getRegion;
					yield return setRegion;
			}
		}
	...
	public partial class  InvocationExpression : Expression {
        ...
        // Why is this member here?  This could easily be accomplished at the call site... 
	    public void AddArg(object arg)
	    {
	        arguments.Add(new IdentifierExpression(arg.ToString()));
	    }
...
[Obsolete] public string FieldName { get { return MemberName; } set { MemberName = value; } }
	...
	public partial class  ObjectCreateExpression : Expression {
		...
		public override IEnumerable<INode> Chilluns {
			get {
					yield return createType;
					yield return objectInitializer;
			}
		}
...
public UsingDeclaration(string @namespace, TypeReference alias) { usings = new List<Using>(1); usings.Add(new Using(@namespace, alias)); }
	...
	public partial class  UsingStatement : StatementWithEmbeddedStatement {
		...
		public override IEnumerable<INode> Chilluns {
			get {
					yield return resourceAcquisition;
			}
		}
	...
	public partial class  VariableDeclaration : AbstractNode {
		...
		public override IEnumerable<INode> Chilluns {
			get {
					yield return initializer;
					yield return typeReference;
					yield return fixedArrayInitialization;
			}
		}
